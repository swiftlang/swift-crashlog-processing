...
**Note**: This document describes the key conventions as specified in the dotnet/symstore repository. Details should be verified against the current specification if used for production implementation work.
